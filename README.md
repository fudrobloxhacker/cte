# cte
CTE serves as a C++ compile time encryption toolset without macro abuse. Unique encryption keys and encryption algorithms for every usage. Completly new output for each compilation. Tested and working on MSVC, Clang, and GCC.
